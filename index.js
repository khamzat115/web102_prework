...
function addGamesToPage(games) {
    ...
    for(let i = 0; i< games.length; i++) {
        ...
        const game_card = document.createElement('div') // creating 11 divs each with class "game-card"
...
//contributionsCard.textContent = numBackers
// set the inner HTML using a template literal and toLocaleString to get a number with commas
contributionsCard.innerHTML=`
    <p>${numBackers.toLocaleString('en-US')}</p>
`
...
function filterUnfundedOnly() {
    ...
    console.log(`unfounded games: ${unfundedGames}`)
...
function filterFundedOnly() {
    ...
    console.log(`unfounded games: ${fundedGames}`)
    // use the function we previously created to add the unfunded games to the DOM
...
Currently, ${num_unfunded} ${num_unfunded>1 ? "games remain": "game remains"} unfunded. We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
const descr = document.createElement('p')
descr.innerHTML= `<p>${displayStr}</p>`
descriptionContainer.append(descr)
/************************************************************************************
